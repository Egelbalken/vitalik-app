      ...
      <div className={style.container}>
        <div className={style['wrapper-grid']}>
          <div className={style.featureCardEarn}>
            <h1>Earn.</h1>
            <p>
              Get rewarded holding your investment in Vitalik 0.4% of
              transaction fees are even distributed to all holders of $VTLK
            </p>
          </div>
          <div className={style.featureCardBurn}>
            ...
            <p>
              ...
              of total transactions. Meaning your holding is worth more for
          ...
          <div className={style.featureCardCharity}>
            <h1>Charity.</h1>
            <p>
              10% of the total tokens are held by development team. Every month
              a poll is made where we as community choose project to donate
              funds for.
            </p>
          </div>
        </div>
